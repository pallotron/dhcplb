...
unicast traffic. It supports broadcast (v4) but not multicast (v6) requests.
...
TODOs and improvements are tracked [in the issue tracker](https://github.com/facebookincubator/dhcplb/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
